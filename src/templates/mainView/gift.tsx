        ...
        <div className="flex flex-col gap-8 pt-4">
          ...
          <div className="flex flex-col md:flex-row gap-8 md:gap-12 justify-center items-start w-full px-4">
            ...
            <motion.div
              ...
              className="flex flex-col items-center w-full md:w-1/2 max-w-[280px] mx-auto bg-white/95 backdrop-blur-sm rounded-2xl p-6 shadow-xl border-2 border-maroon-200 hover:border-gold-400 transition-all duration-300"
            >
              <motion.img 
          ...
          <motion.div
            ...
            className="font-medium z-10 bg-gradient-to-br from-gold-400/10 to-maroon-400/10 backdrop-blur-sm rounded-2xl p-6 mx-4 border-2 border-maroon-200 hover:border-gold-400 transition-all duration-300"
          >
